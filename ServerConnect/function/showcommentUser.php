...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    if($row['username'] == $_SESSION['username']) {
        $show_edit = "<li><a class='dropdown-item' href='../ServerConnect/function/deleteData.php?IdComment=".$row['idComment']."' onclick='return confirm(\"&#10071; Are you sure you want to delete this comment?\")'>	&#128465; Delete</a></li>
